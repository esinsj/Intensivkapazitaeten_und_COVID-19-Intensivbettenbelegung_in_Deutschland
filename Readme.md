...
| intensivbetten_belegt | Natürliche Zahl (Integer) | `≥ 0` | Anzahl der im Meldebereich aktuell belegten sowie zur Belegung am gleichen Tag verplanten Intensivbetten im Rahmen der Akutversorgung, unabhängig von der Behandlungsursache.|
...
| intensivbetten_belegt | Natürliche Zahl (Integer) | `≥ 0` | Anzahl der im Meldebereich aktuell belegten sowie zur Belegung am gleichen Tag verplanten Intensivbetten im Rahmen der Akutversorgung, unabhängig von der Behandlungsursache (Erwachsene und Kinder). |
| intensivbetten_belegt_erwachsen | Natürliche Zahl (Integer) | `≥ 0` | Anzahl der im Meldebereich aktuell belegten sowie zur Belegung am gleichen Tag verplanten Intensivbetten im Rahmen der Akutversorgung, unabhängig von der Behandlungsursache (NUR für Erwachsene). |
